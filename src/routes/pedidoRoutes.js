...
router.post('/checkout', verificarToken, validateCheckout, pedidoController.realizarCheckout);

// Ruta para obtener el historial de pedidos de un cliente
router.get('/cliente/:idCliente', verificarToken, pedidoController.obtenerHistorial);
